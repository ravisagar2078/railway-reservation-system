...
$query1 = "Select username,coachid,trainid,ticket_id,seatno,date,payment,status FROM reservation where status='pending' ";
...
echo "<tr>";
  ...
  echo "</table></center>";
			...
			else
		{
			...
			{
				echo "<br/>";			
				echo "<center><b>NO PENDING TICKETS</b></center>";
				echo "<br/>";			
			}
		}
...
<li><a href="admin_reservation_details.php">CONFIRM TICKETS</a></li>
